...
console.log(challenge.substr(3,189))
...
let firstHalf = challenge.substr(0,10)
let secondHalf = challenge.substr(11,10)
console.log(firstHalf)
console.log(secondHalf)
let wholeSentence = ''
console.log(wholeSentence.concat(firstHalf, ' ' + secondHalf))
...
let pythAndJarg = 'python and jargon'
console.log(pythAndJarg.match(/on/g))
//6 I hope this course is not full of jargon. Check if jargon is in the sentence.
let sentenceJar = 'I hope this course is not full of jargon'
console.log(sentenceJar.includes('jargon'))
...
let salaryincome = salary.match(/\d+/g)
console.log(parseInt((salaryincome[0] * 12)) + parseInt((salaryincome[1])) + parseInt((salaryincome[2] * 12)))
